...
_missionLootVehicles = [
	...
	[selectRandom["O_Truck_02_transport_EPOCH","O_Truck_02_covered_EPOCH","O_Truck_02_box_EPOCH","O_Truck_03_transport_EPOCH","O_Truck_03_covered_EPOCH"],[8,17,0],random 360,_crateLoot,[0,10,2,5,5,1]]
