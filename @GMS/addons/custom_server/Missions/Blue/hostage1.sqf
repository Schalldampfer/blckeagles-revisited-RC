...
_missionLootVehicles = [
	...
	[selectRandom["CUP_O_Hilux_armored_unarmed_TK_INS","CUP_B_HMMWV_Unarmed_USA","CUP_B_HMMWV_Transport_USA","CUP_B_HMMWV_Ambulance_USA","CUP_B_LR_Transport_CZ_D","CUP_B_LR_Transport_CZ_W"],[8,17,0],random 360,_crateLoot,[0,10,2,5,5,1]]
