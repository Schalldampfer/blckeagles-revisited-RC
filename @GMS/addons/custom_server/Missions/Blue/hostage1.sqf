...
_missionLootVehicles = [
	...
	[selectRandom["A2_HMMWV_EPOCH","A2_Vodnik_EPOCH","B_MRAP_01_EPOCH","O_MRAP_02_EPOCH","I_MRAP_03_EPOCH","B_T_LSV_01_unarmed_F","O_LSV_02_unarmed_F","O_T_LSV_02_unarmed_F","B_LSV_01_unarmed_F"],[8,17,0],_crateLoot,[0,10,2,5,5,1]]
