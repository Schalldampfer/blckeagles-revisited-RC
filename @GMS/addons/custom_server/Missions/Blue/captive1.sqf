...
_missionLootVehicles = [
	...
	[selectRandom["C_Van_01_box_EPOCH","C_Van_01_transport_EPOCH","B_Truck_01_mover_EPOCH","B_Truck_01_transport_EPOCH","B_Truck_01_covered_EPOCH","B_Truck_01_box_EPOCH"],[8,17,0],_crateLoot,[0,10,2,5,5,1]]
