...
_missionLootVehicles = [
	[selectRandom["CUP_O_BTR40_MG_TKM","CUP_I_SUV_Armored_ION","CUP_O_Hilux_btr60_TK_INS","CUP_O_Hilux_armored_DSHKM_TK_INS"],[8,17,0],random 360,_crateLoot,_lootCounts]
