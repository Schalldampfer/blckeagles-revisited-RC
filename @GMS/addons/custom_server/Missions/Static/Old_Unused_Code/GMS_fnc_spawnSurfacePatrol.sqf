...
#define shipWaypointTimeout [10,12,5,15]
_vehicle = [_pos,_pos,_vehType,_minDis,_maxDis,_group,true,_numAI,_patrolRadius,shipWaypointTimeout] call blck_fnc_spawnVehiclePatrol;
_vehicle
