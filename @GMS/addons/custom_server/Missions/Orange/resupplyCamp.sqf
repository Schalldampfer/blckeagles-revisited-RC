...
_missionLootVehicles = [
	[selectRandom["CUP_B_M113_USA","CUP_I_M113_AAF","CUP_B_MTLB_pk_FIA","CUP_I_MTLB_pk_SYNDIKAT","CUP_O_GAZ_Vodnik_PK_RU","CUP_O_GAZ_Vodnik_AGS_RU"],[8,17,0],random 360,_crateLoot,_lootCounts]
