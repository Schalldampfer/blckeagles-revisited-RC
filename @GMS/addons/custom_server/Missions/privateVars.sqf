...
private ["_markerLabel","_endMsg","_startMsg","_lootCounts","_crateLoot","_markerMissionName","_missionLandscapeMode","_missionLandscape",
	...
	"_submarinePatrolParameters","_scubaGroupParameters","_vehicleCrewCount","_airpatrols","_lootCrates","_noLootCrates","_lootCratePositions",
	"_markerSize","_markerBrush","_isScubaMission"];
